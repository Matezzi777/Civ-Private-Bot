...
def add_birthday(user : discord.User, date : int):
...
def rem_birthday(user : discord.User):
    connexion = sqlite3.connect('db.sqlite')
    cursor = connexion.cursor()
...
def change_birthday(user : discord.User, date : str):
    connexion = sqlite3.connect('db.sqlite')
    cursor = connexion.cursor()
...
def check_birthday(user : discord.User):
    connexion = sqlite3.connect('db.sqlite')
    cursor = connexion.cursor()
...
def get_birthday(user : discord.User):
    connexion = sqlite3.connect('db.sqlite')
    cursor = connexion.cursor()
